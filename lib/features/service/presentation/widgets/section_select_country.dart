          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: widget.serviceCubit.isCurrent
                  ...
                  : drawerCubit.themeMode == ThemeMode.dark?ColorManager.darkTextFieldBg:Colors.grey.shade100,
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: widget.serviceCubit.isCurrent
                    ? Colors.amber
                    : drawerCubit.themeMode == ThemeMode.dark?ColorManager.textColorLight: Colors.grey.shade300,
                width: 1.5,
              ),
