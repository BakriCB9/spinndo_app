   ...
   for(int i=0;i<widget.listOfworkday.length;i++){
     for(int j=0;j<_profileCubit.dateSelect.length;j++){
       if(_profileCubit.dateSelect[j].day==widget.listOfworkday[i].day){
        ...
        _profileCubit.dateSelect[j].start=widget.listOfworkday[i].start!.substring(0,5);
        print(widget.listOfworkday[i].start!.substring(0,5));
        print("Xxxxx");
        _profileCubit.dateSelect[j].end=widget.listOfworkday[i].end!.substring(0,5);
         print(widget.listOfworkday[i].end!.substring(0,5));
         print("Xxxxx");     break;
       }
     }
   }
   print('the value of list of working day is %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ${_profileCubit.dateSelect}');
    return Scaffold(
      appBar: AppBar(title: Text('Edit Time ',style: TextStyle(fontSize: 35.sp,color: Colors.black),),),
      body:
      Padding(
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButton<String>(
                                    ...
                                    menuMaxHeight: 200,
                                    isExpanded: true,
                                    value:_buildTimeOptions().any((item) => item.value == _profileCubit.dateSelect[index].start)
          ...
          _profileCubit.dateSelect[index]);
                                ...
                                Expanded(
                                  child: DropdownButton<String>(
                                    ...
                                    menuMaxHeight: 200,
                                    iconEnabledColor: ColorManager.primary,
                                    value:_buildTimeOptions().any((item) => item.value == _profileCubit.dateSelect[index].end)
