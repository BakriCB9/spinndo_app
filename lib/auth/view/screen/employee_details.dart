      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            InkWell(
              child: Container(
width: double.infinity,     padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),             decoration: BoxDecoration(
                      border: Border.all(width: 1, color: Colors.black),borderRadius: BorderRadius.all(Radius.circular(10))),
                  child: Row(
                    children: [
                      Icon(Icons.date_range,color: Colors.blue,),Text(
                        "  Select Days",
